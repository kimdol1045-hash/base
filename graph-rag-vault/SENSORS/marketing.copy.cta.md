...
region: SENSORS
token_estimate: 500
theory: "#59 Nudge Theory (Thaler & Sunstein, 2008)"
...
- ← [[marketing.copy.role]] `w=0.9`

### FEEDS (9)

- ← [[marketing.copy.storytelling]] `w=0.7`
- → [[marketing.copy.verify]] `w=0.8`
- ← [[marketing.growth.landing-page]] `w=0.5`
- ← [[marketing.growth.social-media]] `w=0.5`
- ← [[marketing.persuasion.anchoring]] `w=0.5`
- ← [[marketing.persuasion.endowment]] `w=0.5`
- ← [[marketing.persuasion.fogg-model]] `w=0.5`
- ← [[marketing.persuasion.prospect-theory]] `w=0.5`
- ← [[marketing.persuasion.scarcity]] `w=0.5`

...
- [[dev.security.role]] — REQUIRES (weight: 0.85)
- [[dev.security.owasp]] — FEEDS (weight: 0.8)
- [[dev.security.cia-triad]] — FEEDS (weight: 0.8)
- [[dev.security.stride]] — FEEDS (weight: 0.8)
- [[dev.security.nist-framework]] — FEEDS (weight: 0.8)
- [[dev.security.defense-in-depth]] — FEEDS (weight: 0.8)
- [[dev.security.zero-trust]] — FEEDS (weight: 0.8)

...
- [[dev.security.owasp]] — REQUIRES (weight: 0.9)
- [[dev.security.cia-triad]] — REQUIRES (weight: 0.9)
- [[dev.security.stride]] — REQUIRES (weight: 0.9)
- [[dev.security.nist-framework]] — REQUIRES (weight: 0.9)
- [[dev.security.defense-in-depth]] — REQUIRES (weight: 0.9)
- [[dev.security.zero-trust]] — REQUIRES (weight: 0.9)
- [[dev.security.verify]] — REQUIRES (weight: 0.85)
...
- [[dev.security.nist-framework]] — CO_CREATES (weight: 0.6)
- [[dev.security.mitre-attack]] — CO_CREATES (weight: 0.6)

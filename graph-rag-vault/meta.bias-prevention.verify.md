...
- [[meta.bias-prevention.role]] — REQUIRES (weight: 0.85)
- [[meta.bias-prevention.confirmation-bias]] — FEEDS (weight: 0.8)
- [[meta.bias-prevention.availability-bias]] — FEEDS (weight: 0.8)
- [[meta.bias-prevention.planning-fallacy]] — FEEDS (weight: 0.8)
- [[meta.output-validator]] — FEEDS (weight: 0.8)

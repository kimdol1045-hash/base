...
region: EGO
token_estimate: 500
theory: "#72 확증 편향 방지 (Wason, 1960) — 자신의 출력을 의심하고 검증한다"
...
- ← [[meta.bias-prevention.availability-bias]] `w=0.5`
- ← [[meta.bias-prevention.confirmation-bias]] `w=0.5`
- ← [[meta.bias-prevention.dunning-kruger]] `w=0.5`
- ← [[meta.bias-prevention.framing-effect]] `w=0.5`
- ← [[meta.bias-prevention.hindsight-bias]] `w=0.5`
- ← [[meta.bias-prevention.planning-fallacy]] `w=0.7`
- ← [[meta.bias-prevention.role]] `w=0.5`
- ← [[meta.bias-prevention.sunk-cost]] `w=0.5`
- ← [[meta.bias-prevention.survivorship-bias]] `w=0.5`

...
> #80 AARRR Pirate Metrics (McClure, 2007) + HEART (Google, 2010)
...
- [[analytics.ab-testing]] — FEEDS (weight: 0.7)
...
- [[analytics.dora-metrics]] — FEEDS (weight: 0.5)
- [[planning.prd.north-star]] — FEEDS (weight: 0.5)

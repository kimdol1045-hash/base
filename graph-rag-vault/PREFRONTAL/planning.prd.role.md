...
- → [[planning.prd.anti-halluc]] `w=0.9`
- → [[planning.prd.jtbd]] `w=0.9`
- → [[planning.prd.mvp]] `w=0.9`
- → [[planning.prd.risk]] `w=0.9`
- → [[planning.prd.user-story]] `w=0.9`
- → [[planning.prd.verify]] `w=0.85`

### CO_CREATES (1)

- ← [[planning.prd.user-story]] `w=0.6`

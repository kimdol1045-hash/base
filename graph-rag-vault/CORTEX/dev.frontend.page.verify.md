...
- ← [[dev.frontend.component.role]] `w=0.85`
- ← [[dev.frontend.page.role]] `w=0.85`

### FEEDS (3)

- ← [[dev.frontend.component.solid]] `w=0.8`
- ← [[dev.frontend.component.stack]] `w=0.8`
- ← [[dev.frontend.page.routing]] `w=0.8`

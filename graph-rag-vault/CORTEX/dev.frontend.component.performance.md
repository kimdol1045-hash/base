...
region: CORTEX
token_estimate: 500
theory: "#73 React Reconciliation (Facebook, 2013)"
...
- ← [[dev.performance.amdahl]] `w=0.5`
- ← [[dev.performance.budget]] `w=0.5`
- ← [[dev.performance.caching]] `w=0.5`
- ← [[dev.performance.littles-law]] `w=0.5`
- ← [[dev.performance.role]] `w=0.5`
- ← [[dev.performance.web-vitals]] `w=0.5`
